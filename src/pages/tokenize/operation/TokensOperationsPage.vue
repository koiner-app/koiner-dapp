...
import operationsSearchSchema from '@koiner/tokenize/operation/search/token-operations-search.schema.json';
import operationsSearchUiSchema from '@koiner/tokenize/operation/search/view/token-operations-table.ui-schema.json';
