...
import contractsSearchSchema from '@koiner/contract/contract/search/contracts-search.schema.json';
import contractsSearchUiSchema from '@koiner/contract/contract/search/view/contracts-table.ui-schema.json';
