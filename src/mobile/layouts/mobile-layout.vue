...
import MobileMainNavigation from 'src/mobile/components/mobile-main-navigation.vue';
import { useWindowSize } from '@vueuse/core';
import { useRouter } from 'vue-router';
import MobileDrawerNavigation from 'src/mobile/components/mobile-drawer-navigation.vue';
