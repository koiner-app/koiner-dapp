...
import tokenHoldersSearchSchema from '../../../components/holder/search/token-holders-search.schema.json';
import tokenHoldersSearchUiSchema from '../../../components/holder/search/view/token-holders-table.ui-schema.json';
