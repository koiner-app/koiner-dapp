...
export type TransactionPageQuery = { __typename?: 'Query', transaction: { __typename?: 'Transaction', id: string, blockHeight: any, operationCount: number, index: number, signatures: Array<string>, header: { __typename?: 'TransactionHeader', payer: string, nonce?: string | null, operationMerkleRoot?: string | null, rcLimit: string } } };
...
export function useTokenLayoutQuery(options: Omit<Urql.UseQueryArgs<never, TokenLayoutQueryVariables>, 'query'> = {}) {
  return Urql.useQuery<TokenLayoutQuery>({ query: TokenLayoutDocument, ...options });
};