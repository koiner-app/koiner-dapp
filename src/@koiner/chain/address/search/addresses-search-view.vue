...
import addressesSearchSchema from './addresses-search.schema.json';
import addressesSearchUiSchema from './view/addresses-table.ui-schema.json';
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const searchProvider = new AddressesSearchProvider();
