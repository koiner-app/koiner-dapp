...
module.exports = configure(function (/* ctx */) {
  return {
    ...
    boot: ['urql', 'i18n', 'search-client', 'kondor', 'axios', 'posthog'],
    ...
    build: {
      ...
      vitePlugins: [
        [
          ...
          {
            // Required when using $t in template files, see https://github.com/quasarframework/quasar/issues/13483#issuecomment-1133756440
            runtimeOnly: false,
